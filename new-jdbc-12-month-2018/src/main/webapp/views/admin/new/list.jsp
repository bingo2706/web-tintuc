	...
	function deleteNew(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = "${NewURL}?type=list&maxPageItem=5&page=1&sortName=title&sortBy=asc&message=delete_success";
            },
            error: function (error) {
            	window.location.href = "${NewURL}?type=list&maxPageItem=5&page=1&sortName=title&sortBy=ascmessage=error_system";
            }
        });
    }
